...
export const state = {
    ...
    currentTask: null,
    /**
     * Workspace UI: the task currently shown in the detail modal. Null
     * means the modal is closed. The modal walks the parentId chain to
     * build a breadcrumb when drilling into subtasks.
     */
    detailTaskId: null,
