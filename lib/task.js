...
export class ObjectiveTask {
    ...
    addUiElement(container = '#objective-tasks') {
        ...
        <div id="objective-task-item-${this.id}" class="objective-task-item">
            <div class="objective-task-card-top">
                <div id="objective-task-drag-${this.id}" class="objective-task-button fa-solid fa-grip-vertical fa-fw" title="Drag to reorder"></div>
            ...
            <div class="objective-task-card-actions">
                <div id="objective-task-duration-${this.id}" class="objective-task-button fa-solid fa-clock fa-fw" title="Task Duration Settings"></div>
                <div id="objective-task-add-${this.id}" class="objective-task-button fa-solid fa-plus fa-fw" title="Add Sibling"></div>
                <div id="objective-task-delete-${this.id}" class="objective-task-button fa-solid fa-xmark fa-fw" title="Delete Task"></div>
            </div>
        </div>
        `;
    ...
    onAddClick() {
        ...
        parent.addTask('New Task', addAtIndex);
        updateUiTaskList();
        saveState();
    }
