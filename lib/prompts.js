 ...
 *
 * Handles the {{objective}}, {{task}} / {{currentTask}}, {{parent}},
 * {{completedTasks}}, and {{upcomingTasks}} placeholders. Standard
 * SillyTavern macros like {{user}} and {{char}} are left for the host's
 * own substituteParams to handle further down the pipeline.
 */
